...
class Vehicle {
  ...
  public:
    ...
    virtual const string GetDesc() const { return license_ + " " + std::to_string(year_); }
...
class Car : public Vehicle {
  ...
  public:
    ...
    const string GetDesc() const { return "my_style = " + style_; }
};
...
class Truck : public Vehicle {
  ...
  public:
    ...
    const string GetDesc() const { return "my_style = " + bed_length_; }
};
